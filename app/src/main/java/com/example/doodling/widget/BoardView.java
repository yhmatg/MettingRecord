...
import com.example.doodling.widget.shape.CurveShape;
import com.example.doodling.widget.shape.DrawShape;
import com.example.doodling.widget.shape.LineShape;
import com.example.doodling.widget.shape.MultiLineShape;
import com.example.doodling.widget.shape.OvalShape;
import com.example.doodling.widget.shape.RectShape;
import com.example.doodling.widget.shape.ShapeResource;
import com.example.doodling.widget.shape.Type;
import com.example.doodling.widget.shape.WipeShape;
...
public class BoardView extends View {
    ...
    //add 20191028 start
    public void updateDrawFromBitmap(Bitmap mBitmap){
        clearScreen();
        oldBitmap = mBitmap;
    ...
    public Bitmap getDoodleBitmap() {
        ...
        loadBitmapFromLocal(canvas);
        return bitmap;
    }

    public void loadBitmapFromLocal(Canvas mCanvas) {
        for (ShapeResource resource : mSavePath) {
